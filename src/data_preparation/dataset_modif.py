...
dataset_dir = PROJECT_PATH / "datasets/dataset_multimodal_siamese_png_filtered_hard"
output_dir = PROJECT_PATH / "datasets" / name
...
try:
    os.mkdir(output_dir)
    print(str(output_dir) + " folder created\n")
except OSError:
    try:
        shutil.rmtree(output_dir, ignore_errors=True)
        print(str(output_dir) + " foldel deleted\n")
        os.mkdir(output_dir)
        print(str(output_dir) + " folder created\n")
    except OSError:
        print("Aborting\n")
